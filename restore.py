"""
restore.py — irishpeptides-desktop one-click recovery script.
...
DRIVE_SUB     = "irishpeptides-desktop"
DRIVE_SCOPES  = ["https://www.googleapis.com/auth/drive.file"]


def _print(msg: str) -> None:
    print(f"[restore-desktop] {msg}")
...
def post_restore_setup() -> None:
    ...
    _print("Build installer: npm run build")
    _print("Start dev: npm start")
    _print("See RECOVERY.md for full instructions.")


def main() -> None:
    parser = argparse.ArgumentParser(description="irishpeptides-desktop restore")
